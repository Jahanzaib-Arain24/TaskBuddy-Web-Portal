							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										<h2 class="admin-title-heading"><i class="fa fa-pencil-square-o"></i> Edit Task</h2>
										<p class="admin-title-sub">Editing: <strong class="text-primary"><?php echo htmlspecialchars($jobtitle); ?></strong></p>
									</div>
										...
										<form class="post-form-wrapper" action="app/update-job.php" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Task Responsibilies</label>
