...
<head>
	...
	<title>Taskbuddy Jobs - Company Profile</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 class="admin-title-heading"><i class="fa fa-user"></i> Company Profile</h2>
										<p class="admin-title-sub">Last logged in: <span class="text-primary" style="font-weight: 600;"><?php echo "$mylogin"; ?></span></p>
