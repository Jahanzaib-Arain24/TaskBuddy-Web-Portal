...
<head>
	...
	<title>TaskBuddy Jobs - Employee Profile</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 class="admin-title-heading"><i class="fa fa-user-circle"></i> Profile Settings</h2>
										<p class="admin-title-sub">Manage your personal details, bio, and contact information <?php if (!empty($myllogin)): ?>&bull; Last active: <span class="text-primary"><?php echo "$mylogin"; ?></span><?php endif; ?></p>
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
													...
													<div class="form-group">
														...
														<div class="row gap-5">
															<div class="col-xs-4 col-sm-4">
																<select name="date" required class="form-control" style="padding: 6px 10px; font-size: 13.5px; height: 44px;">
																	<option value="">Day</option>
                                                                     <?php 
                                                                      $x = 1; 
                                                                      while($x <= 31) {
												                      $val = ($x < 10) ? "0$x" : "$x";
													                  $sel = ($mydate == $val) ? ' selected ' : '';
															...
															<div class="col-xs-4 col-sm-4">
																<select name="month" required class="form-control" style="padding: 6px 10px; font-size: 13.5px; height: 44px;">
																	<option value="">Month</option>
                                                                     <?php 
                                                                      $x = 1; 
                                                                      while($x <= 12) {
												                      $val = ($x < 10) ? "0$x" : "$x";
													                  $sel = ($mymonth == $val) ? ' selected ' : '';
													                  echo '<option '.$sel.' value="'.$val.'">'.$val.'</option>';
                                                                      $x++;
                                                                      } 
                                                                     ?>
															...
															<div class="col-xs-4 col-sm-4">
																<select name="year" required class="form-control" style="padding: 6px 10px; font-size: 13.5px; height: 44px;">
										...
										<div class="col-sm-12 mt-10">
										<button type="submit" class="btn btn-primary"><i class="fa fa-upload"></i> Update Photo</button>
										<?php 
										if (!empty($myavatar)) {
										?> &nbsp;<a onclick="return confirm('Are you sure you want to delete your profile photo?')" class="btn btn-danger" href="app/drop-dp.php"><i class="fa fa-trash"></i> Delete Photo</a> <?php
										}
										?>
										</div>
										</div>
