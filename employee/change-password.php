...
<head>
	...
	<title>TaskBuddy Jobs - Change Password</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 class="admin-title-heading"><i class="fa fa-key"></i> Security & Password</h2>
										<p class="admin-title-sub">Update your account password to keep your profile secure</p>
											...
											<div class="row gap-20">
                                             <?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 mt-10">
													<button type="submit" onclick="return check_passwords();" class="btn btn-primary"><i class="fa fa-check"></i> Update Password</button>
